...
disc_0 = [get_disc(ana7,ra=0,sindec=d,ext=np.radians(0),llh_ext=None, cut_n_sigma=None, gamma=2, sigsub=True) for d in sindec_array]
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/DiscoveryPotential/disc_0ext_llhextNone_cutnsigNone_gamma2_sigsubTrue_50bins.npy',disc_0)
