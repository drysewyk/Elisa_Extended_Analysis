...
disc_2 = [get_disc(ana7,ra=0,sindec=d,ext=np.radians(2),llh_ext=None, cut_n_sigma=None, gamma=2, sigsub=False) for d in sindec_array]
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/DiscoveryPotential/disc_2ext_llhextNone_cutnsigNone_gamma2_sigsubFalse_50bins.npy',disc_2)
