...
disc_5 = [get_discovery_sigsub(ana7,ra=0,sindec=d,ext=5,gamma=2) for d in dec_array]
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/DiscoveryPotential/disc_5_ss_30bins.npy',disc_5)
