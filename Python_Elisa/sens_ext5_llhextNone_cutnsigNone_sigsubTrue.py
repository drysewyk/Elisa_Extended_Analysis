...
sens_5 = [get_sens(ana7,ra=0,sindec=d,ext=np.radians(5),llh_ext=None, cut_n_sigma=None, gamma=2, sigsub=True) for d in sindec_array]
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/Sensitivity/sens_5ext_llhextNone_cutnsigNone_gamma2_sigsubTrue_50bins.npy',sens_5)
