...
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/Sensitivity/sindec_array_30bins.npy',sindec_array)
...
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/Sensitivity/sens_0ext_llhextNone_cutnsigNone_gamma2_sigsubFalse_30bins.npy',sens_0)
