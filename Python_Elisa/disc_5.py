...
disc_5 = [get_discovery(ana7,ra=0,sindec=d,ext=5,gamma=2) for d in dec_array]
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/DiscoveryPotential/disc_5_30bins.npy',disc_5)
