...
sens_2_ss = [get_sens_sigsub(ana7,ra=0,sindec=d,ext=2,gamma=2) for d in dec_array]
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/Sensitivity/sens_2_ss_30bins.npy',sens_2_ss)
