...
sens_0_ss = [get_sens_sigsub(ana7,ra=0,sindec=d,ext=0,gamma=2) for d in dec_array]
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/Sensitivity/sens_0_ss_30.npy',sens_0_ss)
