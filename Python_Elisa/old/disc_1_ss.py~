...
disc_0 = [get_discovery_sigsub(ana7,ra=0,sindec=d,ext=0,gamma=2) for d in dec_array]
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/DiscoveryPotential/disc_0_ss_30bins.npy',disc_0)
