...
sens_4_ss = [get_sens_sigsub(ana7,ra=0,sindec=d,ext=4,gamma=2) for d in dec_array]
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/Sensitivity/sens_4_ss_30bins.npy',sens_4_ss)
