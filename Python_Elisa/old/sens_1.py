...
sens_1 = [get_sens(ana7,ra=0,sindec=d,ext=1,gamma=2) for d in dec_array]
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/Sensitivity/sens_1_30bins.npy',sens_1)
