...
sens_2 = [get_sens(ana7,ra=0,sindec=d,ext=2,gamma=2) for d in dec_array]
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/Sensitivity/sens_2_30bins.npy',sens_2)
