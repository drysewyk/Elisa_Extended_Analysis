...
disc_1 = [get_discovery(ana7,ra=0,sindec=d,ext=1,gamma=2) for d in dec_array]
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/DiscoveryPotential/disc_1_30bins.npy',disc_1)
