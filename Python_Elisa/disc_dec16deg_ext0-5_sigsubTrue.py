...
disc_0_llhextNone = get_disc(ana7,ra=0,sindec=sindec16,ext=np.radians(0),llh_ext=None, cut_n_sigma=None, gamma=2, sigsub=True)
disc_1_llhextNone = get_disc(ana7,ra=0,sindec=sindec16,ext=np.radians(1),llh_ext=None, cut_n_sigma=None, gamma=2, sigsub=True)
disc_2_llhextNone = get_disc(ana7,ra=0,sindec=sindec16,ext=np.radians(2),llh_ext=None, cut_n_sigma=None, gamma=2, sigsub=True)
disc_3_llhextNone = get_disc(ana7,ra=0,sindec=sindec16,ext=np.radians(3),llh_ext=None, cut_n_sigma=None, gamma=2, sigsub=True)
disc_4_llhextNone = get_disc(ana7,ra=0,sindec=sindec16,ext=np.radians(4),llh_ext=None, cut_n_sigma=None, gamma=2, sigsub=True)
disc_5_llhextNone = get_disc(ana7,ra=0,sindec=sindec16,ext=np.radians(5),llh_ext=None, cut_n_sigma=None, gamma=2, sigsub=True)
...
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/DiscoveryPotential/disc_llhextNone_sigsubTrue.npy',disc_llhextNone)

disc_0_llhext0 = get_disc(ana7,ra=0,sindec=sindec16,ext=np.radians(0),llh_ext=np.radians(0), cut_n_sigma=None, gamma=2, sigsub=True)
disc_1_llhext0 = get_disc(ana7,ra=0,sindec=sindec16,ext=np.radians(1),llh_ext=np.radians(0), cut_n_sigma=None, gamma=2, sigsub=True)
disc_2_llhext0 = get_disc(ana7,ra=0,sindec=sindec16,ext=np.radians(2),llh_ext=np.radians(0), cut_n_sigma=None, gamma=2, sigsub=True)
disc_3_llhext0 = get_disc(ana7,ra=0,sindec=sindec16,ext=np.radians(3),llh_ext=np.radians(0), cut_n_sigma=None, gamma=2, sigsub=True)
disc_4_llhext0 = get_disc(ana7,ra=0,sindec=sindec16,ext=np.radians(4),llh_ext=np.radians(0), cut_n_sigma=None, gamma=2, sigsub=True)
disc_5_llhext0 = get_disc(ana7,ra=0,sindec=sindec16,ext=np.radians(5),llh_ext=np.radians(0), cut_n_sigma=None, gamma=2, sigsub=True)
...
np.save('/data/user/drysewyk/llh_sandbox/NumPyArrays/DiscoveryPotential/disc_llhext0_sigsubTrue.npy',disc_llhext0)
