...
export JAVA_HOME="/cvmfs/icecube.opensciencegrid.org/py2-v3.0.1/../distrib/jdk1.6.0_24_RHEL_7_x86_64" ;
...
/data/user/drysewyk/software/meta-projects/icerec/V05-02-00/build/env-shell.sh python Python_Elisa/back_5_ss.py
date
